      ...
      <div className="px-[5vw] max-w-[1700px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-start">
          ...
          <div className="lg:col-span-8">
            ...
            >
              {[
                ...
                <span
                  key={i}
                  className="reveal-word font-display text-4xl sm:text-5xl md:text-6xl lg:text-[5vw] leading-[1.1] font-light tracking-tighter transition-colors"
                >
                  {word}
                </span>
              ))}
          ...
          <div className="lg:col-span-4 flex flex-col gap-8 pt-12 lg:pt-32">
            {/* Card 1: Präzision */}
            <div
              className="about-card p-8 md:p-10 rounded-[40px] relative overflow-hidden group cursor-default"
              style={{
                background:
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h4 className="font-display text-2xl text-white font-medium uppercase tracking-wider">
                    Präzision
                  </h4>
                </div>
                <p className="text-white/60 text-lg font-light leading-relaxed">
                  Jedes Detail zählt. Unsere Analysen lassen keinen Raum für
                  Zufälle. Wir agieren hocheffizient in jeder Disziplin.
                </p>
              </div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/60 text-lg font-light leading-relaxed">
                  Sicherheit, die man nicht sieht, aber deren Präsenz absolute
                  Souveränität verleiht. Über 5 Jahre Erfahrung.
                </p>
              </div>
              <div className="absolute top-0 right-0 w-32 h-32 bg-brand/10 blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
            </div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/60 text-lg font-light italic leading-relaxed">
                  &quot;Sicherheit ist kein Produkt, sondern ein Versprechen,
                  das wir jeden Tag durch elite Standards halten.&quot;
                </p>
              </div>
              <div className="absolute top-0 right-0 w-32 h-32 bg-brand/10 blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
            </div>
