...
export function Expertise() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full bg-[#0B0B0C] py-32 text-white overflow-hidden"
    >
        ...
        <div className="expertise-header-anim px-[5vw] mb-20 flex flex-col items-start gap-6">
          ...
          <div className="max-w-xl">
            <p className="text-white/50 text-xl md:text-2xl font-light leading-relaxed">
              Maßgeschneiderte Sicherheitsarchitektur für höchste Ansprüche in
          ...
          {AREAS.map((area) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 w-full p-8 z-20 flex flex-col justify-end h-full">
                <span className="font-mono text-[#7CB3D1] text-xl mb-4 opacity-50 group-hover:opacity-100 transition-opacity">
                  {area.id}
                </span>
