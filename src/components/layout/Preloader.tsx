...
export function Preloader() {
  ...
  useGSAP(
    () => {
      ...
      tl.to(
        [headingStartRef.current, headingEndRef.current, statusRef.current],
        {
          opacity: 0,
    ...
    >
      <div className="relative w-full h-full flex flex-col items-center justify-center">
        ...
        >
          <div ref={headingStartRef} className="flex overflow-hidden shrink-0">
            <span ref={addToLetters} className="inline-block relative">
              S
            </span>
            <span ref={addToLetters} className="inline-block relative">
              I
          ...
          >
            <div ref={growingImageRef} className="relative w-full h-full">
              <div
                className="absolute inset-0 z-40"
                ref={(el) => {
                  if (el) extraImagesRef.current[0] = el;
                }}
              >
                <img
              ...
              <div
                ...
                ref={(el) => {
                  if (el) extraImagesRef.current[1] = el;
                }}
              >
                <img
                  className="absolute inset-0 w-full h-full object-cover"
              ...
              <div
                ...
                ref={(el) => {
                  if (el) extraImagesRef.current[2] = el;
                }}
              >
                <img
                  className="absolute inset-0 w-full h-full object-cover"
              ...
              <div
                ...
                ref={(el) => {
                  if (el) extraImagesRef.current[3] = el;
                }}
              >
                <img
                  className="absolute inset-0 w-full h-full object-cover"
      ...
      >
        <div className="font-display text-[14px] md:text-[18px] font-bold text-[#201d1d] uppercase tracking-wider">
          <span className="text-brand">©</span> {new Date().getFullYear()}{" "}
