...
export const siteConfig = {
  ...
  locale: "de_DE",
  description:
    "Professioneller Sicherheitsdienst in Sachsen. Objektschutz, Baustellenbewachung, Veranstaltungsschutz & Brandwachen — diskret, zuverlässig, gegründet 2026.",
  keywords: [
    "Sicherheitsdienst Sachsen",
    "Sicherheitsdienst Bad Gottleuba",
    "Objektschutz Sachsen",
    "Baustellenbewachung Sachsen",
    "Veranstaltungsschutz Sachsen",
    "Brandwache Sachsen",
    "Security Sachsen",
  ],
  phone: "+49 174 8884697",
  email: "niklas-gaertner@web.de",
  address: {
